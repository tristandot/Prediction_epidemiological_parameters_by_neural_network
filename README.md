...
Use the Nextflow Pipeline (File: [Laplacian_Spectrum_Neural_Network/nextflow_construction.nf](https://gitlab.pasteur.fr/mmoslonk/ABC_NeuralNetworks/blob/master/Laplacian_Spectrum_Neural_Network/nextflow_construction.nf)) to filter the Newick forest and generate the Laplacian Spectrums for each tree. 
The code used to generate the Eigen Values of each tree is located in:  [Laplacian_Spectrum_Neural_Network/bin/spectreR.R](https://gitlab.pasteur.fr/mmoslonk/ABC_NeuralNetworks/blob/master/Laplacian_Spectrum_Neural_Network/bin/spectreR.R).
...
It is a work in progress, that can be found in the following Python Script: [Laplacian_Spectrum_Neural_Network/bin/generate_embeddings.py](https://gitlab.pasteur.fr/mmoslonk/ABC_NeuralNetworks/blob/master/Laplacian_Spectrum_Neural_Network/bin/generate_embeddings.py), and is in commentary in the current pipeline.
...
[Laplacian_Spectrum_Neural_Network/Network.ipynb](https://gitlab.pasteur.fr/mmoslonk/ABC_NeuralNetworks/blob/master/Laplacian_Spectrum_Neural_Network/Network.ipynb).
